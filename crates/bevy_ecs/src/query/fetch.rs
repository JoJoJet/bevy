...
/// This will also create an additional struct, representing the read-only variant of the query.
/// For a type named `Q`, the read-only variant will be named `QReadOnly`.
///
/// ```
/// # use bevy_ecs::prelude::*;
/// # use bevy_ecs::query::WorldQuery;
