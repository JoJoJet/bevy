...
use super::{QueryItem, QueryState, WorldQuery, WorldQueryFilter};
...
pub struct QueryParIter<'w, 's, Q: WorldQuery, F: WorldQueryFilter> {
...
impl<'w, 's, Q: WorldQuery, F: WorldQueryFilter> QueryParIter<'w, 's, Q, F> {
